...
export async function execute(interaction) {
  ...
  try {
    ...
    if (role.position >= guild.members.me.roles.highest.position) {
      return interaction.reply({ content: 'Bot không thể thêm vai trò cao hơn hoặc bằng vai trò cao nhất của bot!', ephemeral: true });
    }
    ...
    await interaction.reply({ content: "Có lỗi xảy ra khi thêm vai trò. Vui lòng thử lại sau.", ephemeral: true });
  }
}